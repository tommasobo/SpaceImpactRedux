 ...
 * @param <B> The type of the first element of the pair
 */
...
public class Pair<A, B> {
	...
	/**Pair constructor.
	 * 
	 * @param firstParam The first element of the pair (type A)
	 * @param secondParam The second element of the pair (type A)
	 */
